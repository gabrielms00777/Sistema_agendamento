            ...
            <div class="row justify-content-center">
                <div class="col-12 col-xl-10">
                    ...
                    <div class="row align-items-center my-4">
                        <div class="col">
                            <h2 class="h3 mb-0 page-title">Editar Serviço</h2>
                        </div>
                        <div class="col-auto">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="active" name="status" value="1"
                                        class="custom-control-input" @if ($service->status == true) checked @endif>
                                    <label class="custom-control-label" for="active">Ativo</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="inative" name="status" value="0"
                                        class="custom-control-input" @if ($service->status == false) checked @endif>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    placeholder="Nome do Serviço" value="{{$service->name}}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="time">Tempo de execução</label>
                                <input class="form-control" id="time" type="time" name="time" value="{{$service->time}}">
                            </div>
                        </div>
                        <div class="form-row mb-3">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" id="value" name="value" class="form-control"
                                    placeholder="Ex:R$ 100.00" value="{{$service->value}}">
                            </div>
                        </div>
                        <div class="form-row">
